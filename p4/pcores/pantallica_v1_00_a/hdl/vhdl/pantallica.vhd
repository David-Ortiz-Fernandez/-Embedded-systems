------------------------------------------------------------------------------
-- pantallica.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          pantallica.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Thu Nov 16 16:14:23 2017 (by Create and Import Peripheral Wizard)
...
library pantallica_v1_00_a;
use pantallica_v1_00_a.user_logic;
...
end entity pantallica;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of pantallica is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity pantallica_v1_00_a.user_logic
    generic map
    (
    ...
    (
      ...
      -- MAP USER PORTS ABOVE THIS LINE ------------------
		hsyncb=>hsyncb,
		vsyncb=>vsyncb,							-- vertical (frame) sync
		rgb=>rgb,	-- red,green,blue colors
      Bus2IP_Clk                     => ipif_Bus2IP_Clk,
      Bus2IP_Reset                   => ipif_Bus2IP_Reset,
      Bus2IP_Data                    => ipif_Bus2IP_Data,
      Bus2IP_BE                      => ipif_Bus2IP_BE,
