/*****************************************************************************
* Filename:          C:\hlocal\p2-20171023T092356Z-001\p2/drivers/my_plb_peripheral_v1_00_a/src/my_plb_peripheral_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the my_plb_peripheral driver
...
XStatus MY_PLB_PERIPHERAL_SelfTest(void * baseaddr_p)
{
  ...
  MY_PLB_PERIPHERAL_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MY_PLB_PERIPHERAL_mReadSlaveReg0(baseaddr, 0);
